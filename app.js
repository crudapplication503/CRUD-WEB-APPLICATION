        ...
        for(var i=tab_start; i<tab_end; i++){
            var staff = getData[i]
              ...
              if(staff){
                ...
                <td>
                    <button onclick="readInfo('${staff.fName}', '${staff.lName}', '${staff.ageVal}', '${staff.cityVal}', '${staff.positionVal}', '${staff.salaryVal}', '${staff.sDateVal}','${staff.statVal}','${staff.emailVal}', '${staff.phoneVal}','${staff.guideVal}')"><i class="fa-regular fa-eye"></i></button>

                    <button onclick="editInfo('${i}','${staff.fName}', '${staff.lName}', '${staff.ageVal}', '${staff.cityVal}', '${staff.positionVal}', '${staff.salaryVal}', '${staff.sDateVal}','${staff.statVal}','${staff.emailVal}', '${staff.phoneVal}','${staff.guideVal}')"><i class="fa-regular fa-pen-to-square"></i></button>
...
function readInfo(fname, lname, Age, City, Position, Salary, SDate,Stat, Email, Phone,Guide){
...
function editInfo(id,  fname, lname, Age, City, Position, Salary, SDate,Stat, Email, Phone,Guide){
    isEdit = true
    editId = id
